...
You can view my academic and research profile in [ResearchGate](https://www.researchgate.net/profile/Vasilis_Myrgiotis). 
...
- **Model-data fusion (MDF)** is the process of using observations of agro-ecosystem functionings to improve the reliability of agro-ecosystem models and their predictions. A MDF algorithm using DALEC-Grass can be found [here](https://github.com/vmyrgiotis/DALEC_Grass).
