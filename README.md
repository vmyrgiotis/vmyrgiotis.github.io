...
DALEC-Grass is a simple model that simulates photosynthesis, carbon allocation and biomass removal (i.e. grazing and cutting) in managed grasslands. You can access the code of the model in https://github.com/vmyrgiotis/DALEC_Grass
