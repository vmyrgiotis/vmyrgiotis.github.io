...
- **Model-data fusion (MDF)** is the use of observations about a system in order to inform a model of that system about the system's actual state. The aim of MDF is to improve the reliability of a model and its predictions. A MDF algorithm using DALEC-Grass can be found [here](https://github.com/vmyrgiotis/DALEC_Grass).
